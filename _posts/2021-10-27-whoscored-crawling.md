...
이 *유용한 친구(crwaler)* 를 만들기 위해서 활용한 소프트웨어는 Python, Selenium, Chrome webdriver 이다.
Selenium은 웹 자동화 테스트(버튼 클릭, 스크롤 조작 등)에 사용되는 프레임워크이고, 
자동적으로 원하는 정보가 있는 페이지를 찾아서, 필요한 소스에 접근하게 해준다.
Selenium 프레임워크를 Chorme 브라우저에서 활용하기 위해서 Chrome webdriver 가 필요하다.
Selenium 기반 crawler는 python 을 통해 쉽게 구현할 수 있다. 
...
<p align="center">
<img src='http://drive.google.com/uc?export=view&id=11DFElgxvXdzAEA4iVvnh_8DNonhP3Q7f' width=500/><br>
</p>
...
| team_number |               team_name |  P |  W |  D |  L | GF | GA |  GD | Pts |
|------------:|------------------------:|---:|---:|---:|---:|---:|---:|----:|----:|
| 167         | Manchester City         | 38 | 27 | 5  | 6  | 83 | 32 | +51 | 86  |
