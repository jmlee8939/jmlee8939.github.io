...
공격수의 가치는 "골을 얼마나 많이 생산해 내는 가"로 결정된다. 축구 기사를 보다보면 **'공격수는 골로 말한다'** 라는 말이 자주 등장하는 것도 그 때문이다.
...
퍼포먼스를 평가하기 위해서 활용할 수 있는 스탯들이 더 많았지만, 개인적으론 단순하고 명확한 평가지표가 퍼포먼스를 비교하는 데 훨씬 효율적이라고 생각한다.
